...
for i = 1:length(EbNo_dB)
    ...
    for j = 1:N_symbols
        ...
        detected_symbols = received_symbols(active_indices);
        ...
        received_symbols_ofdm = qpsk_symbols_ofdm + noise_ofdm;
        
        detected_symbols_ofdm = received_symbols_ofdm;
...
legend('FOFDM-IM', 'OFDM');
title('BER Comparison of FOFDM-IM and OFDM in Narrowband IoT');
